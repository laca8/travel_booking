...
<h1 className='p-2 bg-gray-400 rounded-sm text-white font-bold mb-2'>الحالة التعليمية</h1>
<div className='flex flex-row w-96 '>
    ...
    <button className='bg-gray-400 p-1 text-white cursor-pointer' onClick={()=>handleAdd()}>اضافة</button>
</div>
